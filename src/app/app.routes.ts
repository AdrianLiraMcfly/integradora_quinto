...
export const routes: Routes = [
    ...
    { path: 'home', loadComponent:() => import('./home/home.component').then(m => m.HomeComponent), canActivate: [tokenGuard, ActiveGuard]},
    { path: 'plants', loadComponent:() => import('./plants/plants.component').then(m => m.PlantsComponent), canActivate: [tokenGuard,ActiveGuard]},
    { path: 'users', loadComponent:() => import('./users/users.component').then(m => m.UsersComponent), canActivate: [tokenGuard,ActiveGuard]},
